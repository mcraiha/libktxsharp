...
public static class Common
{
	...
	/// <summary>
	/// VkFormats that are NOT allowed to be used in KTX2
	/// </summary>
	/// <remarks>See https://github.khronos.org/KTX-Specification/ktxspec.v2.html#prohibitedFormats</remarks>
	public static readonly FrozenSet<VkFormat> prohibitedFormats = new HashSet<VkFormat>()
	{
